...
- [x] **Step 3: Create `src/vite-env.d.ts`**
...
- [x] **Step 1: Create `convex/schema.ts`**
...
- [x] **Step 2: Create `convex/auth.config.ts`**
...
- [x] **Step 3: Regenerate Convex types**
...
- [x] **Step 1: Update `src/landing/LandingGate.tsx`**
...
- [x] **Step 2: Rewrite `src/landing/LandingGate.test.tsx`**
...
- [x] **Step 1: Rewrite the data layer in `src/App.tsx`**
...
- [x] **Step 2: Add a `CHANGELOG.md` entry**
...
- [x] **Step 3: Full test suite + coverage**
