...
import { LOAN_PRODUCTS, calculateLoan, formatJODNumber } from '../utils/loanCalculator';
...
export const LoanCalculator: React.FC<LoanCalculatorProps> = ({ profile, onSaveRecord }) => {
  ...
  const handleSaveCalculation = () => {
    const newRecord: LoanRecord = {
      id: `rec_${Date.now()}`,
      referenceNo: `MDB-${new Date().getFullYear()}-${Math.floor(1000 + Math.random() * 9000)}`,
    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6 flex flex-col gap-6 mt-2">
      ...
      {saveNotification && (
        <div className="p-4 bg-emerald-600 text-white font-medium rounded-xl shadow-lg flex items-center justify-between animate-fade-in text-sm">
          ...
          <button onClick={() => setSaveNotification(null)} className="text-white/80 hover:text-white cursor-pointer">
            ✕
          </button>
        </div>
      )}
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center bg-white dark:bg-[#191c1e] p-6 rounded-xl border border-[#c2c7ca] dark:border-gray-800 shadow-xs gap-4 transition-colors">
        <div className="text-center sm:text-right w-full flex justify-between items-center">
          <div>
            <h2 className="text-lg font-bold text-[#0f4c81] dark:text-[#95ccff] mb-0.5">
              نسبة الربح المعتمدة
            </h2>
          ...
          <p className="text-3xl font-extrabold text-[#191c1e] dark:text-white font-mono bg-[#f2f4f6] dark:bg-gray-800 px-5 py-2 rounded-xl border border-gray-200 dark:border-gray-700">
            {result.profitRate}%
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 flex flex-col gap-4 bg-white dark:bg-[#191c1e] p-6 rounded-xl border border-[#c2c7ca] dark:border-gray-800 shadow-xs border-r-4 border-r-[#0f4c81] dark:border-r-[#95ccff] transition-colors">
          <h2 className="text-xl font-bold text-[#0f4c81] dark:text-[#95ccff] border-b border-gray-200 dark:border-gray-800 pb-3 mb-1 flex items-center justify-between">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="w-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-[#0f4c81] text-sm font-medium text-gray-900 dark:text-gray-100 cursor-pointer"
            >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-[#0f4c81] text-sm text-right font-mono text-gray-900 dark:text-gray-100"
              placeholder="500"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5 mt-2">
            ...
            <div className="w-full bg-[#f2f4f6] dark:bg-gray-800/80 border border-gray-300 dark:border-gray-700 rounded-lg p-3 text-sm text-gray-900 dark:text-gray-100 flex justify-between items-center">
              <span className="font-bold text-base font-mono text-[#0f4c81] dark:text-[#95ccff]">
          ...
          <button
            ...
            className="mt-3 w-full bg-[#23639a] hover:bg-[#0f4c81] text-white py-3 rounded-lg font-bold text-base transition-all active:scale-95 shadow-md cursor-pointer flex items-center justify-center gap-2"
          >
            <span>حساب</span>
          </button>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          ...
          <div className="bg-white dark:bg-[#191c1e] p-6 rounded-xl border border-[#c2c7ca] dark:border-gray-800 shadow-xs border-t-4 border-t-[#0f4c81] dark:border-t-[#95ccff] transition-colors">
            
            <h2 className="text-xl font-bold text-[#0f4c81] dark:text-[#95ccff] mb-5 flex items-center gap-2">
              <Receipt className="w-6 h-6 text-[#0f4c81] dark:text-[#95ccff]" />
            ...
            <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-800">
              <table className="w-full text-right border-collapse text-sm">
                <tbody>
                  ...
                  <tr className="bg-white dark:bg-[#191c1e] border-b border-gray-200 dark:border-gray-800">
                  ...
                  <tr className="bg-[#f7f9fb] dark:bg-gray-800/40 border-b border-gray-200 dark:border-gray-800">
            ...
            <div className="mt-6 flex flex-wrap justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#0f4c81] text-white px-5 py-2.5 rounded-lg text-sm font-bold hover:bg-[#00355f] transition-all cursor-pointer shadow-sm active:scale-95"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 bg-white dark:bg-[#191c1e] border-2 border-[#0f4c81] text-[#0f4c81] dark:text-[#95ccff] dark:border-[#95ccff] px-5 py-2.5 rounded-lg text-sm font-bold hover:bg-[#0f4c81]/10 transition-colors cursor-pointer active:scale-95"
              >
          ...
          {/* Disclaimer Info Box */}
          <div className="bg-[#f2f4f6] dark:bg-gray-800/60 p-4 rounded-xl border border-[#c2c7ca] dark:border-gray-700 flex items-start gap-3">
            <Info className="w-5 h-5 text-[#34645d] dark:text-[#bcebe5] mt-0.5 shrink-0" />
